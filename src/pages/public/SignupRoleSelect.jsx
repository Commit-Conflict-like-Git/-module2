...
import '../../assets/css/signupPages/roleSelect.css'
        ...
        <div className='inner-body'>
            ...
            <div className='role-container'>
                <div className='role-select'>
                    <img src="src/assets/img/dog.svg" alt="보호자" className='role-image'/>
                ...
                <div className='role-select'>
                    <img src="src/assets/img/trainer.svg" alt="훈련사" className='role-image'/>
